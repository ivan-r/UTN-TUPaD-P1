# Trabajo Poráctico 3: Estructuras condicionales
# Ivan Rapoport
...
nota = int(input("Ingrese un número par: "))
...
if len(frase) > 0:
    ultima = frase[len(frase) - 1]
    if ultima in ["a", "e", "i", "o", "u"]:
        print(frase + "!")
    else:
        print(frase)
...
#     ● Mayor o igual que 4 y menor que 5: "Moderado" (sentido por personas, pero generalmente no 
#       causa daños).
